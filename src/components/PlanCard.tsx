...
const PlanCard: React.FC<CardProps> = ({ plan, pricing, features, link }) => (
  <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md lg:h-max lg:scale-105 z-10 translate-y-0 transition-transform duration-200">
    <div className="p-6 text-center">
      ...
      <a
        className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-85 focus:shadow-none active:opacity-85 active:shadow-none w-full flex items-center justify-center gap-4"
        href={link!}
        target="_blank">
        join
        <svg
